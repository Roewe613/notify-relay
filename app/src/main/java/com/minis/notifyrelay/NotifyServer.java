...
public class NotifyServer {
    ...
    private static final String HTML_PAGE =
        ...
        + ".card{background:#101a2cE8;border:1px solid #28415e;border-radius:10px;padding:14px;margin-bottom:12px;box-shadow:0 0 18px #0b7d9b20}"
        ...
        + "</style></head><body>"
        + "<div class=card><h1>通知枢纽 <span id=status class=wait>● CONNECTING</span></h1>"
